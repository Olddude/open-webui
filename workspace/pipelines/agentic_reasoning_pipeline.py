...
class Pipeline:
    ...
    async def inlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        agentic_triggers = [
            "plan", "break down", "step by step", "analyze", 
            "create a strategy", "multiple steps", "complex task"
        ]
        
        should_use_agentic = any(trigger in user_input.lower() for trigger in agentic_triggers)
    ...
    async def create_plan(self, user_input: str, user: Optional[dict] = None) -> AgenticPlan:
    ...
    async def update_task_progress(self, plan_id: str, task_id: str, progress: int, status: str = None):
